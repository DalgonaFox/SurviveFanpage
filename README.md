<h1 align="center"> Survive Said The Prophet - Fanpage </h1>
...
* **Carrossel Interativo:** Uma galeria de videoclipes totalmente funcional controlada por botões direcionais.
* **Filtro e Busca Dinâmica:** Uma área dedicada à discografia da banda, onde o usuário pode pesquisar músicas pelo nome ou ordená-las (por popularidade, mais recentes, mais antigas) usando JavaScript.
* **Integração com APIs Externas:** *Embed* do player do Spotify diretamente na página para que os visitantes possam ouvir os grandes sucessos enquanto navegam.
* **Modais Nativos:** Uso da tag moderna `<dialog>` em conjunto com JS para exibir janelas pop-up (como alertas de envio no formulário de mensagens).
...
* Meta tags e propriedades de *Open Graph* (`og:title`, `og:image`, etc.) configuradas para gerar *previews* otimizados e elegantes ao compartilhar o link do site no WhatsApp, Discord ou X/Twitter.
